...
path = 'C:\\Users\\vikr\\FinProjects\\DecisionTrees\\'
...
plt.savefig(path + 'Basic decision tree 20240_1537.pdf')
plt.show()
...
plt.savefig(path + 'Basic decision tree importance 2024_1537.pdf')
plt.show()
...
plt.savefig(path + 'Basic decision tree train 2024_1537.pdf')
plt.show()
...
plt.xticks(rotation=90)
plt.savefig(path + 'Basic decision tree importance train 2024_1537.pdf')
plt.show()
...
with pd.ExcelWriter(path + 'Decision-tree output 2024_1537.xlsx') as writer:
